...
const ZodiacMonthly = () => {
  ...
  useEffect(() => {
    const fetchHoroscope = async () => {
      ...
      try {
        // Corrected API URL with 'today' type for daily horoscope
        const response = await axios.post(`http://localhost:5000/horoscope/today/${sign.name.toLowerCase()}`);
